const AboutSelf = () => {
  return (
    <section className="bg-primary lg:py-36 py-24 ">
      <div className=" p-5 lg:w-[50%] w-[85%] mx-auto">
        <h4 className=" ;g:text-3xl text-2xl font-semibold font-[EuroStyle Normal] text-center text-tlight pb-10">
