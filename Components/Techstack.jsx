...
const Techstack = () => {
  return (
    <section className="dark:bg-bdark">
      <section className="shadow w-[85%]  mx-auto rounded-2xl -translate-y-36 bg-blight lg:p-16 lg:py-16 py-10 lg:px-10 px-7 dark:bg-dcard">
