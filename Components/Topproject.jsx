  ...
  return (
    <seciton className=" flex flex-col items-center border dark:border-gray-800 lg:py-20 py-16 dark:bg-bdark">
      ...
      <Link href="#" className="pt-10">
        <button
          type="button"
          className="capitalize border-[3px] rounded-full py-4 px-10 lg:text-xl text-lg border-primary mx-auto text-primary hover:bg-primary hover:text-tlight dark:bg-primary dark:text-white "
        >
          show more
        </button>
      </Link>
