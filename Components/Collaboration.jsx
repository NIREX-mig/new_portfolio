...
const Collaboration = () => {
  return (
    <section className="border flex flex-col items-center px-5 dark:bg-black dark:border-gray-800 ">
      ...
      <button type="button" className=" flex gap-3 items-center mx-auto border-[3px] text-primary border-primary hover:bg-primary hover:text-tlight rounded-full px-10 py-3 lg:text-xl text-sm mb-20" > 
      <MdChat size={25} />
